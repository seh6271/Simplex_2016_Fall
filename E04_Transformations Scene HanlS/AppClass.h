...
class Application
{
	//create 46 meshes + store in vector
	std::vector<MyMesh*> m_vpCubes;	
	//create a vector for the transform matrices
	std::vector<vector3> m_vv3Transforms;
	int timer;
	float change;
...
#pragma region Helper Methods
	/*
	USAGE: Sets the initial transformations for the cubes for the excerise in m_vm4Transforms
	ARGUMENTS: ---
	OUTPUT: ---
	*/
	void SetPositions();
	...
	/*
	USAGE: Adds the change value to the x coordinate of all matrices
	ARGUMENTS: ---
	OUTPUT: ---
	*/
	void MoveShape();
